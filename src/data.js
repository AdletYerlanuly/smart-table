...
export function initData() {
    ...
    const getRecords = async (query, isUpdated = false) => {
        ...
        if (lastQuery === nextQuery && !isUpdated) { // если параметры запроса не поменялись — отдаём сохранённые данные
            return lastResult;
        }

        // если прошлый квери не был установлен или поменялись параметры — запрашиваем данные с сервера
